class Api::V1::AccountsController < Api::BaseController
  ...
  def permitted_settings_attributes
    [:auto_resolve_after, :auto_resolve_message, :auto_resolve_ignore_waiting, :audio_transcriptions,
     :audio_transcription_provider, :auto_resolve_label]
  end
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless StarchatsCaptcha.new(params[:h_captcha_client_response]).valid?
  end
