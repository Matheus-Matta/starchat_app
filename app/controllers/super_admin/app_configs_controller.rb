class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      'email' => %w[MAILER_INBOUND_EMAIL_DOMAIN ACCOUNT_EMAILS_LIMIT],
      ...
      'cosmos' => %w[COSMOS_OPEN_AI_API_KEY COSMOS_OPEN_AI_MODEL COSMOS_OPEN_AI_ENDPOINT]
    }
  ...
  def success_notice
    ...
    "#{message.delete_suffix('.')}. Restart Starchats web and worker processes to apply this change everywhere."
  end
