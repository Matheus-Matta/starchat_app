...
describe('#StarchatAccountAPI', () => {
  ...
  describe('API calls', () => {
    ...
    it('#checkout', () => {
      accountAPI.checkout();
      expect(axiosMock.post).toHaveBeenCalledWith('/starchat/api/v1/checkout');
    });

    it('#subscription', () => {
      accountAPI.subscription();
      expect(axiosMock.post).toHaveBeenCalledWith(
        '/starchat/api/v1/subscription'
      );
    });
    ...
    it('#toggleDeletion with delete action', () => {
      ...
      expect(axiosMock.post).toHaveBeenCalledWith(
        '/starchat/api/v1/toggle_deletion',
        { action_type: 'delete' }
      );
    });
