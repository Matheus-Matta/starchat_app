...
const props = defineProps({
  ...
  responsibleAgentIds: { type: Array, default: () => [] },
  responsibleAgents: { type: Array, default: () => [] },
...
const getInitialContactData = () => ({
  ...
  responsibleAgentIds: props.responsibleAgentIds,
  responsibleAgents: props.responsibleAgents,
