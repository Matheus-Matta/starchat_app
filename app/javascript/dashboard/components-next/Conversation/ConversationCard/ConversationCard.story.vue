...
const conversationWithoutMeta = {
  meta: {
    sender: {
      ...
      email: 'candice@starchats.com.br',
      id: 29,
  ...
  messages: [
    {
      ...
      conversation: {
        ...
        contactInbox: {
          sourceId: 'candice@starchats.com.br',
        },
      },
    },
  ],
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      contact_inbox: {
        source_id: 'candice@starchats.com.br',
      },
    },
    sender: {
      id: 1,
...
const conversationWithMeta = {
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      last_activity_at: 1730885428,
      contact_inbox: {
        source_id: 'willy@starchats.com.br',
      },
    },
    sender: {
      id: 1,
