<<<<<<< HEAD:app/javascript/dashboard/components-next/cosmos/pageComponents/assistant/AssistantForm.vue
<script setup>
...
const getErrorMessage = (field, errorKey) => {
  return v$.value[field].$error
    ? t(`COSMOS.ASSISTANTS.FORM.${errorKey}.ERROR`)
    : '';
};
...
>>>>>>> v4.5.0:app/javascript/dashboard/components-next/COSMOS/pageComponents/assistant/AssistantForm.vue
