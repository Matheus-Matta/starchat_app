...
const formState = {
  uiFlags: useMapGetter('cosmosCustomTools/getUIFlags'),
};
...
const authTypeOptions = computed(() => [
  { value: 'none', label: t('COSMOS.CUSTOM_TOOLS.FORM.AUTH_TYPES.NONE') },
  { value: 'bearer', label: t('COSMOS.CUSTOM_TOOLS.FORM.AUTH_TYPES.BEARER') },
  { value: 'basic', label: t('COSMOS.CUSTOM_TOOLS.FORM.AUTH_TYPES.BASIC') },
  {
    value: 'api_key',
    label: t('COSMOS.CUSTOM_TOOLS.FORM.AUTH_TYPES.API_KEY'),
  },
]);
...
const getErrorMessage = (field, errorKey) => {
  return v$.value[field].$error
    ? t(`COSMOS.CUSTOM_TOOLS.FORM.${errorKey}.ERROR`)
    : '';
};
...
<template>
  ...
  >
    <Input
      v-model="state.title"
      :label="t('COSMOS.CUSTOM_TOOLS.FORM.TITLE.LABEL')"
      :placeholder="t('COSMOS.CUSTOM_TOOLS.FORM.TITLE.PLACEHOLDER')"
    ...
    <TextArea
      ...
      :label="t('COSMOS.CUSTOM_TOOLS.FORM.DESCRIPTION.LABEL')"
      :placeholder="t('COSMOS.CUSTOM_TOOLS.FORM.DESCRIPTION.PLACEHOLDER')"
      :rows="2"
    />
    ...
    <div class="flex gap-2">
      <div class="flex flex-col gap-1 w-28">
        <label class="mb-0.5 text-sm font-medium text-n-slate-12">
          {{ t('COSMOS.CUSTOM_TOOLS.FORM.HTTP_METHOD.LABEL') }}
        </label>
        <ComboBox
      ...
      <Input
        ...
        :label="t('COSMOS.CUSTOM_TOOLS.FORM.ENDPOINT_URL.LABEL')"
        :placeholder="t('COSMOS.CUSTOM_TOOLS.FORM.ENDPOINT_URL.PLACEHOLDER')"
    ...
    <div class="flex flex-col gap-1">
      <label class="mb-0.5 text-sm font-medium text-n-slate-12">
        {{ t('COSMOS.CUSTOM_TOOLS.FORM.AUTH_TYPE.LABEL') }}
      </label>
      <ComboBox
    ...
    <div class="flex flex-col gap-2">
      <label class="text-sm font-medium text-n-slate-12">
        {{ t('COSMOS.CUSTOM_TOOLS.FORM.PARAMETERS.LABEL') }}
      </label>
      <p class="text-xs text-n-slate-11 -mt-1">
        {{ t('COSMOS.CUSTOM_TOOLS.FORM.PARAMETERS.HELP_TEXT') }}
      </p>
      ...
      <Button
        ...
        blue
        icon="i-lucide-plus"
        :label="t('COSMOS.CUSTOM_TOOLS.FORM.ADD_PARAMETER')"
        @click="addParam"
      />
    </div>
    ...
    <TextArea
      ...
      :label="t('COSMOS.CUSTOM_TOOLS.FORM.REQUEST_TEMPLATE.LABEL')"
      :placeholder="t('COSMOS.CUSTOM_TOOLS.FORM.REQUEST_TEMPLATE.PLACEHOLDER')"
      :rows="4"
    ...
    <TextArea
      ...
      :label="t('COSMOS.CUSTOM_TOOLS.FORM.RESPONSE_TEMPLATE.LABEL')"
      :placeholder="t('COSMOS.CUSTOM_TOOLS.FORM.RESPONSE_TEMPLATE.PLACEHOLDER')"
      :rows="4"
      class="[&_textarea]:font-mono"
    />
    ...
    <div class="flex gap-3 justify-between items-center w-full">
      ...
      <Button
        type="submit"
        :label="t(mode === 'edit' ? 'COSMOS.FORM.EDIT' : 'COSMOS.FORM.CREATE')"
        class="w-full"
