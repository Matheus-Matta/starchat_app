...
const { accountScopedRoute, isOnStarchatsCloud } = useAccount();
...
const menuItems = computed(() => {
  return [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          getterKeys: {
            count: 'conversationStats/getParticipatingCount',
          },
        },
        {
          name: 'Unattended',
    ...
    },
    {
      ...
      icon: 'i-woot-cosmos',
      label: 'Cosmos',
      activeOn: ['cosmos_assistants_create_index'],
      children: [
        {
          name: 'FAQs',
          ...
          activeOn: [
            ...
            'cosmos_assistants_responses_pending',
          ],
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          label: t('SIDEBAR.REPORTS_MONITORING'),
          to: accountScopedRoute('monitoring_reports'),
        },
        {
