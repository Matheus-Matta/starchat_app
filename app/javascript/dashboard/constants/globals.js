export default {
  ...
  DOCS_URL: 'https://www.starchats.com.br/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://www.starchats.com.br/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.starchats.com.br/content.json',
