export const FEATURE_FLAGS = {
  ...
  STARCHATS_V4: 'chatwoot_v4',
  CHANNEL_INSTAGRAM: 'channel_instagram',
  CHANNEL_TIKTOK: 'channel_tiktok',
  CHANNEL_VOICE: 'channel_voice',
  CHANNEL_YCLOUD: 'channel_ycloud',
  CONTACT_STARCHATS_SUPPORT_TEAM: 'contact_starchats_support_team',
  COSMOS_CUSTOM_TOOLS: 'custom_tools',
  COSMOS_V2: 'cosmos_integration_v2',
  COSMOS_TASKS: 'cosmos_tasks',
  COSMOS_DOCUMENT_AUTO_SYNC: 'cosmos_document_auto_sync',
  SAML: 'saml',
  COMPANIES: 'companies',
...
export const PREMIUM_FEATURES = [
  ...
  FEATURE_FLAGS.COSMOS_CUSTOM_TOOLS,
