...
export const COSMOS_EVENTS = Object.freeze({
  // Editor funnel events
  EDITOR_AI_MENU_OPENED: 'Cosmos: Editor AI menu opened',
  GENERATION_FAILED: 'Cosmos: Generation failed',
  AI_ASSISTED_MESSAGE_SENT: 'Cosmos: AI-assisted message sent',

  // Rewrite events (with operation attribute in payload)
  REWRITE_USED: 'Cosmos: Rewrite used',
  REWRITE_APPLIED: 'Cosmos: Rewrite applied',
  REWRITE_DISMISSED: 'Cosmos: Rewrite dismissed',

  // Summarize events
  SUMMARIZE_USED: 'Cosmos: Summarize used',
  SUMMARIZE_APPLIED: 'Cosmos: Summarize applied',
  SUMMARIZE_DISMISSED: 'Cosmos: Summarize dismissed',

  // Reply suggestion events
  REPLY_SUGGESTION_USED: 'Cosmos: Reply suggestion used',
  REPLY_SUGGESTION_APPLIED: 'Cosmos: Reply suggestion applied',
  REPLY_SUGGESTION_DISMISSED: 'Cosmos: Reply suggestion dismissed',

  // Follow-up events
  FOLLOW_UP_SENT: 'Cosmos: Follow-up sent',

  // Label suggestions
  LABEL_SUGGESTION_APPLIED: 'Cosmos: Label suggestion applied',
  LABEL_SUGGESTION_DISMISSED: 'Cosmos: Label suggestion dismissed',
});
...
export const COPILOT_EVENTS = Object.freeze({
  ...
  USE_COSMOS_RESPONSE: 'Copilot: Used cosmos response',
});
