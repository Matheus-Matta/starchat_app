...
export default {
  ...
  computed: {
    ...
    whatsappAppId() {
      return window.starchatsConfig?.whatsappAppId;
    },
    isForwardingEnabled() {
      ...
      >
        ...
        <template #subTitle>
          ...
          <a
            ...
            href="https://www.starchats.com.br/docs/product/channels/live-chat/sdk/identity-validation/"
          >
        ...
        <template #editor>
          ...
          <p class="mt-1.5 text-label-small text-n-slate-11">
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.starchats.com/docs/product/channels/live-chat/sdk/identity-validation/"
