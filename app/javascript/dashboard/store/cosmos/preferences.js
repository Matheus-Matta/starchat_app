...
import CosmosPreferencesAPI from 'dashboard/api/cosmos/preferences';

export const useCosmosConfigStore = defineStore('cosmosConfig', {
  state: () => ({
    providers: {},
    models: {},
    features: {},
  ...
  actions: {
    async fetch() {
      ...
      try {
        const response = await CosmosPreferencesAPI.get();
    ...
    async updatePreferences(data) {
      const response = await CosmosPreferencesAPI.updatePreferences(data);
      this.providers = response.data.providers || {};
      this.models = response.data.models || {};
      this.features = response.data.features || {};
    },
