...
const state = {
  ...
  accountReport: {
    isFetching: {
      ...
      unique_contacts_count: false,
      status_open_count: false,
      status_resolved_count: false,
      status_snoozed_count: false,
      status_pending_count: false,
  ...
  accountSummary: {
    ...
    status_open_count: 0,
    status_resolved_count: 0,
    status_snoozed_count: 0,
