export default {
  ...
  SET_PARTICIPATING_CONV_COUNT: 'SET_PARTICIPATING_CONV_COUNT',
  ...
  SET_INBOX_COSMOS_ASSISTANT: 'SET_INBOX_COSMOS_ASSISTANT',
  ...
  TOGGLE_TEAM_CONVERSATION_METRIC_LOADING:
    'TOGGLE_TEAM_CONVERSATION_METRIC_LOADING',
  SET_MONITORING_FETCHING: 'SET_MONITORING_FETCHING',
  SET_MONITORING_SNAPSHOT: 'SET_MONITORING_SNAPSHOT',
  SET_MONITORING_ERROR: 'SET_MONITORING_ERROR',
  SET_MONITORING_AGENT_SUMMARIES: 'SET_MONITORING_AGENT_SUMMARIES',
  SET_MONITORING_INBOX_SUMMARIES: 'SET_MONITORING_INBOX_SUMMARIES',
  UPDATE_MONITORING_AGENT_PRESENCE: 'UPDATE_MONITORING_AGENT_PRESENCE',
  ...
  // Conversation Flows
  SET_CONVERSATION_FLOWS_UI_FLAG: 'SET_CONVERSATION_FLOWS_UI_FLAG',
  SET_CONVERSATION_FLOWS: 'SET_CONVERSATION_FLOWS',
  SET_CONVERSATION_FLOW: 'SET_CONVERSATION_FLOW',
  ADD_CONVERSATION_FLOW: 'ADD_CONVERSATION_FLOW',
  EDIT_CONVERSATION_FLOW: 'EDIT_CONVERSATION_FLOW',
  DELETE_CONVERSATION_FLOW: 'DELETE_CONVERSATION_FLOW',
  ...
  // Protocol Policies
  SET_PROTOCOL_POLICIES_UI_FLAG: 'SET_PROTOCOL_POLICIES_UI_FLAG',
  SET_PROTOCOL_POLICIES: 'SET_PROTOCOL_POLICIES',
  ADD_PROTOCOL_POLICY: 'ADD_PROTOCOL_POLICY',
  EDIT_PROTOCOL_POLICY: 'EDIT_PROTOCOL_POLICY',
  DELETE_PROTOCOL_POLICY: 'DELETE_PROTOCOL_POLICY',

  // Protocols (recursos SAC)
  SET_PROTOCOLS_UI_FLAG: 'SET_PROTOCOLS_UI_FLAG',
  SET_PROTOCOLS: 'SET_PROTOCOLS',
  SET_PROTOCOLS_META: 'SET_PROTOCOLS_META',
  ADD_PROTOCOL: 'ADD_PROTOCOL',
  EDIT_PROTOCOL: 'EDIT_PROTOCOL',
  DELETE_PROTOCOL: 'DELETE_PROTOCOL',

  // Protocol Comments (anotações SAC)
  SET_PROTOCOL_COMMENTS_UI_FLAG: 'SET_PROTOCOL_COMMENTS_UI_FLAG',
  SET_PROTOCOL_COMMENTS: 'SET_PROTOCOL_COMMENTS',
  ADD_PROTOCOL_COMMENT: 'ADD_PROTOCOL_COMMENT',
  DELETE_PROTOCOL_COMMENT: 'DELETE_PROTOCOL_COMMENT',
};
