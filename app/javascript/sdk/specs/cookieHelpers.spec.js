...
describe('#getUserCookieName', () => {
  it('returns correct cookie name', () => {
    global.$starchats = { websiteToken: '123456' };
...
describe('#getUserString', () => {
  it('returns correct user string', () => {
    expect(
      getUserString({
        user: {
          ...
          avatar_url: 'https://images.starchats.com.br/placeholder',
          identifier_hash: '12345',
        },
        identifier: '12345',
      })
    ).toBe(
      'avatar_urlhttps://images.starchats.com.br/placeholderemailpranav@example.comnamePranavidentifier_hash12345identifier12345'
    );
    ...
    expect(
      ...
      'avatar_urlhttps://images.starchats.com.br/placeholderemailpranav@example.comnameidentifier_hashidentifier'
    );
  });
});
