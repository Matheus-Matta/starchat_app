...
export function useBranding() {
  ...
  /**
   * Replaces "Starchats" in text with the installation name from global config
   * @param {string} text - The text to process
   * @returns {string} - Text with "Starchats" replaced by installation name
   */
  const replaceInstallationName = text => {
    ...
    return text.replace(/Starchats/g, installationName);
  };
