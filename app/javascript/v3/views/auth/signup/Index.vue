...
const isAStarchatsInstance = computed(
  () => globalConfig.value.installationName === 'Starchats'
);

onBeforeMount(() => {
  isLoading.value = isAStarchatsInstance.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': isAStarchatsInstance }"
    >
