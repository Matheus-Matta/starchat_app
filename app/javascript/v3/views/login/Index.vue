...
export default {
  ...
  computed: {
    ...
    allowedLoginMethods() {
      return window.starchatsConfig.allowedLoginMethods || ['email'];
    },
    showGoogleOAuth() {
      return (
        this.allowedLoginMethods.includes('google_oauth') &&
        Boolean(window.starchatsConfig.googleOAuthClientId)
      );
    },
    showSignupLink() {
      return window.starchatsConfig.signupEnabled === 'true';
    },
    showSamlLogin() {
