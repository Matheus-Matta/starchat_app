...
describe('useAvailability', () => {
  const originalWindow = window.starchatsWebChannel;
  ...
  afterEach(() => {
    window.starchatsWebChannel = originalWindow;
  });
  ...
  describe('config changes', () => {
    it('should react to window.starchatsWebChannel changes', () => {
