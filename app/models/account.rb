...
class Account < ApplicationRecord
    ...
    'properties':
      {
        ...
        'audio_transcription_provider': { 'type': %w[string null], 'enum': ['openai', 'whisper', nil] },
        'auto_resolve_label': { 'type': %w[string null] },
        'require_contact_inbox_messaging': { 'type': %w[boolean null] },
        'prioritize_responsible_agent': { 'type': %w[boolean null] }
      },
    'required': [],
  ...
  has_many :protocol_policies, dependent: :destroy_async
  has_many :protocols, dependent: :destroy_async
  has_many :protocol_comments, dependent: :destroy_async
  ...
  has_one_attached :companies_export
  ...
  def usage_limits
    {
      agents: StarchatsApp.max_limit.to_i,
      inboxes: StarchatsApp.max_limit.to_i
    }
  end
