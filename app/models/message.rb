...
class Message < ApplicationRecord
  searchkick callbacks: false if StarchatsApp.advanced_search_allowed?
  ...
  def valid_first_reply?
    ...
    return false if conversation.messages.outgoing
                                .where.not(sender_type: ['AgentBot', 'Cosmos::Assistant'])
  ...
  def bot_response?
    # Check if this is a response from AgentBot or Cosmos::Assistant
    outgoing? && sender_type.in?(['AgentBot', 'Cosmos::Assistant'])
  end
