class CreateCosmosCustomTools < ActiveRecord::Migration[7.1]
  def change
    create_table :cosmos_custom_tools do |t|
    ...
    add_index :cosmos_custom_tools, [:account_id, :slug], unique: true
  end
end
