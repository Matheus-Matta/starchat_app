...
ActiveRecord::Schema[7.1].define(version: 2026_07_21_000000) do
  ...
  create_table "cosmos_faq_observations", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "conversation_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_cosmos_faq_observations_on_account_id"
    t.index ["conversation_id", "faq_suggestion_id"], name: "idx_cosmos_faq_observations_on_conversation_and_suggestion", unique: true, where: "(faq_suggestion_id IS NOT NULL)"
    t.index ["conversation_id"], name: "index_cosmos_faq_observations_on_conversation_id"
    t.index ["faq_suggestion_id"], name: "index_cosmos_faq_observations_on_faq_suggestion_id"
  end

  create_table "cosmos_faq_suggestions", force: :cascade do |t|
    t.string "question", null: false
    t.text "answer", null: false
    t.vector "embedding", limit: 1536
    t.bigint "assistant_id", null: false
    ...
    t.index ["account_id"], name: "index_cosmos_faq_suggestions_on_account_id"
    t.index ["assistant_id"], name: "index_cosmos_faq_suggestions_on_assistant_id"
    t.index ["embedding"], name: "vector_idx_cosmos_faq_suggestions_embedding", opclass: :vector_cosine_ops, using: :ivfflat
  end
  ...
  create_table "cosmos_message_reports", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "conversation_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_cosmos_message_reports_on_account_id"
    t.index ["conversation_id"], name: "index_cosmos_message_reports_on_conversation_id"
    t.index ["message_id"], name: "index_cosmos_message_reports_on_message_id"
    t.index ["user_id"], name: "index_cosmos_message_reports_on_user_id"
  end
  ...
  create_table "data_import_items", force: :cascade do |t|
    ...
    t.integer "status", default: 0, null: false
    t.string "starchats_record_type"
    t.bigint "starchats_record_id"
  ...
  create_table "data_import_mappings", force: :cascade do |t|
    ...
    t.string "source_object_type", null: false
    t.string "source_object_id", null: false
    t.string "starchats_record_type", null: false
    t.bigint "starchats_record_id", null: false
    t.jsonb "metadata", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
