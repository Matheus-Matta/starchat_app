...
class ChatwootHub
  BASE_URL = ENV.fetch('CHATWOOT_HUB_URL', 'https://hub.star.dev.br')
  ...
  COSMOS_ACCOUNTS_URL = "#{BASE_URL}/instance_cosmos_accounts".freeze
  ...
  def self.get_cosmos_settings(account)
    info = {
      installation_identifier: installation_identifier,
      chatwoot_account_id: account.id,
      account_name: account.name
    }
    HTTParty.post(COSMOS_ACCOUNTS_URL,
                  body: info.to_json,
