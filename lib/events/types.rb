...
module Events::Types
  ...
  CONVERSATION_COSMOS_INFERENCE_RESOLVED = 'conversation.cosmos_inference_resolved'
  CONVERSATION_COSMOS_INFERENCE_HANDOFF = 'conversation.cosmos_inference_handoff'
