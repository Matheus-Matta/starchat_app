module Redis::RedisKeys
  ...
  STARCHATS_INSTALLATION_ONBOARDING = 'STARCHATS_INSTALLATION_ONBOARDING'.freeze
  ...
  COSMOS_DOCUMENT_SYNC_MUTEX = 'COSMOS_DOCUMENT_SYNC_LOCK::%<document_id>s'.freeze
  COSMOS_CONVERSATION_FAQ_MUTEX = 'COSMOS_CONVERSATION_FAQ_LOCK::%<assistant_id>s::%<language>s'.freeze
