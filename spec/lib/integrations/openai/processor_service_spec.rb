...
RSpec.describe Integrations::Openai::ProcessorService do
  ...
  describe '#perform' do
    ...
    describe 'endpoint configuration' do
      ...
      context 'without COSMOS_OPEN_AI_ENDPOINT configured' do
        before { InstallationConfig.find_by(name: 'COSMOS_OPEN_AI_ENDPOINT')&.destroy }
      ...
      context 'with COSMOS_OPEN_AI_ENDPOINT configured' do
        before do
