...
describe Email::SendOnEmailService do
  ...
  describe '#perform' do
    ...
    context 'when an error occurs' do
      ...
      let(:exception_tracker) { instance_double(StarchatsExceptionTracker, capture_exception: true) }
      ...
      it 'captures the exception' do
        expect(StarchatsExceptionTracker).to receive(:new).with(error, account: message.account)
