...
RSpec.describe 'Api::V1::Accounts::Cosmos::Scenarios', type: :request do
  ...
  describe 'GET /api/v1/accounts/{account.id}/cosmos/assistants/{assistant.id}/scenarios' do
  ...
  describe 'GET /api/v1/accounts/{account.id}/cosmos/assistants/{assistant.id}/scenarios/{id}' do
    ...
    context 'when it is an un-authenticated user' do
      it 'returns unauthorized status' do
        get "/api/v1/accounts/#{account.id}/cosmos/assistants/#{assistant.id}/scenarios/#{scenario.id}"
        expect(response).to have_http_status(:unauthorized)
      end
    end
    ...
    context 'when scenario does not exist' do
      it 'returns not found status' do
        get "/api/v1/accounts/#{account.id}/cosmos/assistants/#{assistant.id}/scenarios/999999",
            headers: agent.create_new_auth_token
  ...
  describe 'POST /api/v1/accounts/{account.id}/cosmos/assistants/{assistant.id}/scenarios' do
    ...
    context 'when it is an un-authenticated user' do
      it 'returns unauthorized status' do
        post "/api/v1/accounts/#{account.id}/cosmos/assistants/#{assistant.id}/scenarios",
  ...
  describe 'PATCH /api/v1/accounts/{account.id}/cosmos/assistants/{assistant.id}/scenarios/{id}' do
    ...
    context 'when it is an un-authenticated user' do
      it 'returns unauthorized status' do
        patch "/api/v1/accounts/#{account.id}/cosmos/assistants/#{assistant.id}/scenarios/#{scenario.id}",
  ...
  describe 'DELETE /api/v1/accounts/{account.id}/cosmos/assistants/{assistant.id}/scenarios/{id}' do
    ...
    context 'when it is an admin' do
      ...
      context 'when scenario does not exist' do
        it 'returns not found status' do
          delete "/api/v1/accounts/#{account.id}/cosmos/assistants/#{assistant.id}/scenarios/999999",
                 headers: admin.create_new_auth_token
