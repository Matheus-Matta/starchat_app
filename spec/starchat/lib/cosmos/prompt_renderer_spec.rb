...
RSpec.describe Cosmos::PromptRenderer do
  let(:template_name) { 'test_template' }
  let(:template_content) { 'Hello {{name}}, your balance is {{balance}}' }
  let(:template_path) { Rails.root.join('starchat', 'lib', 'cosmos', 'prompts', "#{template_name}.liquid") }
  ...
  describe '.load_template' do
    ...
    it 'constructs correct template path' do
      expected_path = Rails.root.join('starchat/lib/cosmos/prompts/my_template.liquid')
