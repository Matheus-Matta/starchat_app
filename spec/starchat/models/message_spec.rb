...
RSpec.describe Message do
  ...
  it 'updates first reply if the message is human and even if there are messages from cosmos' do
    cosmos_assistant = create(:cosmos_assistant, account: conversation.account)
    ...
    create(:message, message_type: :outgoing, conversation: conversation, sender: cosmos_assistant)
