...
RSpec.describe Message do
  ...
  it 'updates first reply if the message is human and even if there are messages from captain' do
    cosmos_::assistant = create(:cosmos_::assistant, account: conversation.account)
    ...
    create(:message, message_type: :outgoing, conversation: conversation, sender: cosmos_::assistant)
