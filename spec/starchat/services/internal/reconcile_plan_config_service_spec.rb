  ...
  describe '#perform' do
    ...
    context 'when pricing plan is community' do
      ...
      it 'disables the premium features for accounts' do
        ...
        account_with_cosmos.enable_features!('cosmos_integration')
        disable_branding_account = create(:account)
        disable_branding_account.enable_features!('disable_branding')
        service.perform
        expect(account.reload.enabled_features.keys).not_to include('cosmos_integration', 'disable_branding', 'audit_logs')
        expect(account_with_cosmos.reload.enabled_features.keys).not_to include('cosmos_integration')
    ...
    context 'when pricing plan is not community' do
      ...
      it 'does not disable the premium features for accounts' do
        ...
        expect(account_with_cosmos.reload.enabled_features.keys).to include('cosmos_integration')
