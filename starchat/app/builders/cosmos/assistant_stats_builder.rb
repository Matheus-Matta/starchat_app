...
class Cosmos::AssistantStatsBuilder
  ...
  def initialize(assistant, range = Cosmos::AssistantStatsWindow::DEFAULT_RANGE, timezone_offset = nil, suggestions_scope: nil)
    @assistant = assistant
  ...
  def faq_stats
    approved, suggestions, documents = Cosmos::AssistantResponse.by_assistant(assistant.id).reorder(nil).pick(
