class Api::V1::Accounts::Cosmos::BulkActionsController < Api::V1::Accounts::BaseController
  ...
  def delete_documents
    documents = Current.account.cosmos_documents.where(id: params[:ids])
  ...
  def sync_documents
    ...
    Current.account.cosmos_documents.where(id: params[:ids]).find_each(batch_size: 100) do |document|
