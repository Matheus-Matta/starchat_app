class Api::V1::Accounts::Cosmos::CustomToolsController < Api::V1::Accounts::BaseController
  before_action :current_account
  before_action -> { check_authorization(Cosmos::CustomTool) }
  ...
  def account_custom_tools
    @account_custom_tools ||= Current.account.cosmos_custom_tools
  end
