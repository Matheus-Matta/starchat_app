class Api::V1::Accounts::Cosmos::FaqSuggestionsController < Api::V1::Accounts::BaseController
  before_action :current_account
  before_action -> { check_authorization(Cosmos::FaqSuggestion) }
  ...
  def approve
    ...
    @response = Cosmos::FaqSuggestionApprovalService.new(@suggestion, attributes).perform
  end
  ...
  def set_accessible_suggestions
    @suggestions = Cosmos::FaqSuggestionFinder.new(Current.user, Current.account).perform.includes(:assistant).ordered
  end
