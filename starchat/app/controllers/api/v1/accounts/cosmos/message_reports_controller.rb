class Api::V1::Accounts::Cosmos::MessageReportsController < Api::V1::Accounts::BaseController
  ...
  def ensure_cosmos_message
    return if @message.sender_type == 'Cosmos::Assistant'

    render json: { error: 'Only Cosmos messages can be reported' }, status: :unprocessable_entity
  end
