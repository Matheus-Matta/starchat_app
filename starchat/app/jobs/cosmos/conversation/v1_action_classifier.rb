module Cosmos::Conversation::V1ActionClassifier
  private

  def v1_action_classifier_enabled?
    account.feature_enabled?('cosmos_v1_action_classifier')
  end
  ...
  def classify_v1_response_action(message_history)
    ...
    classification = Cosmos::Llm::AssistantActionClassifierService.new(
      assistant: @assistant,
  ...
  def valid_v1_action_classification?(action)
    Cosmos::AssistantActionSchema::ACTIONS.include?(action)
  end
