# == Schema Information
#
# Table name: cosmos_custom_tools
#
...
# Indexes
#
#  index_cosmos_custom_tools_on_account_id           (account_id)
#  index_cosmos_custom_tools_on_account_id_and_slug  (account_id,slug) UNIQUE
#
class Cosmos::CustomTool < ApplicationRecord
  include Concerns::Toolable
  include Concerns::SafeEndpointValidatable

  self.table_name = 'cosmos_custom_tools'
  ...
  def find_unique_slug(base_slug)
    ...
    raise ActiveRecord::RecordNotUnique, I18n.t('cosmos.custom_tool.slug_generation_failed')
  end
