...
# Indexes
#
#  idx_cosmos_documents_on_account_assistant_sync_stats        (account_id,assistant_id,sync_status,last_synced_at)
#  idx_cosmos_documents_on_assistant_id_and_external_link_md5  (assistant_id, md5(external_link)) UNIQUE
#  index_cosmos_documents_on_account_id                        (account_id)
#  index_cosmos_documents_on_account_id_and_sync_status        (account_id,sync_status)
