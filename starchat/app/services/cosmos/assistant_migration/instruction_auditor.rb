class Cosmos::AssistantMigration::InstructionAuditor < Cosmos::BaseTaskService
  ...
  def perform
    make_api_call(
      model: AUDITOR_MODEL,
      messages: messages,
      schema: Cosmos::AssistantMigration::InstructionAuditorSchema.for(available_additions)
    )
  end
  ...
  def system_prompt
    Cosmos::PromptRenderer.render('instruction_auditor')
  end
