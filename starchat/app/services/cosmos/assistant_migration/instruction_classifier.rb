class Cosmos::AssistantMigration::InstructionClassifier < Cosmos::BaseTaskService
  RESPONSE_SCHEMA = Cosmos::AssistantMigration::InstructionClassifierSchema
  ...
  def perform
    ...
    auditor_response = Cosmos::AssistantMigration::InstructionAuditor.new(
      assistant: assistant,
  ...
  def system_prompt
    Cosmos::PromptRenderer.render('instruction_classifier')
  end
  ...
  def available_agent_tools
    tools = assistant.respond_to?(:available_agent_tools) ? assistant.available_agent_tools : Cosmos::Assistant.built_in_agent_tools
  ...
  def assistant_metadata # rubocop:disable Metrics/AbcSize
    {
      ...
      account_id: assistant.account_id,
      account_name: assistant.account.name,
      inbox_count: assistant.cosmos_inboxes.size,
