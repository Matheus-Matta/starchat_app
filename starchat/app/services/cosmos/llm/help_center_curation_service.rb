class Cosmos::Llm::HelpCenterCurationService < Cosmos::BaseTaskService
  RESPONSE_SCHEMA = Cosmos::Llm::HelpCenterCurationSchema
  ...
  # debit the customer's cosmos_responses quota.
