class Cosmos::Tools::FaqLookupTool < Cosmos::Tools::BasePublicTool
  ...
  def record_retrieved_sources(tool_context, responses)
    ...
    document_ids = responses.filter_map { |response| response.documentable_id if response.documentable_type == 'Cosmos::Document' }
