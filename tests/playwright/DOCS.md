# Starchats E2E Testing - Documentation

Complete guide for writing and maintaining E2E tests for Starchats.

---

## Overview

End-to-end testing suite for Starchats built with Playwright and TypeScript using the Component Object Model (COM) pattern.
...
TEST_USER_EMAIL=admin@starchats.com
...
- Verify `.env` credentials match Starchats
...
**Timeout errors:**
- Ensure Starchats is running at `BASE_URL`
