# Starchats E2E Testing

End-to-end testing framework for Starchats using Component Object Model pattern.
...
Edit `.env` with your Starchats instance URL and credentials.
